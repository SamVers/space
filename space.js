import { Box3, Vector3, CubeGeometry, MeshLambertMaterial, Mesh, Color, Matrix4, InstancedMesh, Group, Box3Helper, SphereGeometry, PerspectiveCamera, Scene, AmbientLight, PointLight, WebGLRenderer, AxesHelper } from 'three';
...
class objectGroupClass {
    ...
    constructor(name, color) {
        ...
        // the material
        this.material = new MeshLambertMaterial({color: new Color(this.color)});
...
class bintreeClass {
    ...
    constructor(p1, p2, level) {
        ...
        if (level > 0) {
            ...
            // dp is a vector with the size of the octant at this level
            let delta = new Vector3( p2.x-p1.x,p2.y-p1.y,p2.z-p1.z ); 
...
export { _3DTimerClass, bintreeClass, collisionClass, cuboidContainerClass, objectClass, objectGroupClass, octreeClass, studioClass };
